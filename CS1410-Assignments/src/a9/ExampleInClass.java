...
public class ExampleInClass extends JPanel implements ActionListener {
	...
	public ExampleInClass() {
		...
		// Load images
		try {
			plantImage = ImageIO.read(new File("src/a9/frog-icon.png"));
			zombieImage = ImageIO.read(new File("src/a9/chihuahua-icon.png"));
		} catch (IOException e) {
			System.out.println("A file was not found");
			System.exit(0);
		}
	//Create final int parameters for the number
